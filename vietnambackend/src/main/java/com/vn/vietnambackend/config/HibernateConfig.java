package com.vn.vietnambackend.config;
...
@Configuration
@ComponentScan(basePackages= {"com.vn.vietnambackend.dto"})
...
public class HibernateConfig {
	...
	private final static String DATABASE_PASSWORD = "Aa123456";
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.vn.vietnambackend.dto");
