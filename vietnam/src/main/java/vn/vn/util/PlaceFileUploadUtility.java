...
public class PlaceFileUploadUtility {
	
	private static String ABS_PATH = "";
	private static String REAL_PATH ="";
	public static void uploadFile(HttpServletRequest request, MultipartFile file, String code, String nameCity, String namePlace) {
